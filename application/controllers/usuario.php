...
public function add()
    {
        ...
        if ($this->input->server('REQUEST_METHOD') === 'POST')
        {
            ...
            //form validation
	        	...
	        	$this->form_validation->set_rules('id_time', 'id_time', 'required'); 
	        	...
	        	$this->form_validation->set_rules('avaliador', 'avaliador', 'required'); 
            ...
            {
                $data_to_store = array('id_empresa' => $this->input->post('id_empresa'),
'id_time' => $this->input->post('id_time'),
'nome_usuario' => $this->input->post('nome_usuario'),
'email_usuario' => $this->input->post('email_usuario'),
'login' => $this->input->post('login'),
'admin' => $this->input->post('admin'),
'avaliador' => $this->input->post('avaliador'),

                );
                //if the insert has returned true then we show the flash message
                if($this->usuariodao->store_usuario($data_to_store)){
        ...
        //load the view
        $data['main_content'] = 'admin/usuario/add';
        $this->load->view('includes/template', $data);  
    }       
    ...
    public function update()
    {
        ...
        //form validation
        	...
        	'avaliador' => $this->input->post('avaliador'),                    
                ...
                //if the insert has returned true then we show the flash message
                if($this->usuariodao->update_usuario($id, $data_to_store) == TRUE){
                    $this->session->set_flashdata('flash_message', 'updated');
                }else{
                    $this->session->set_flashdata('flash_message', 'not_updated');
                }
                redirect('admin/usuario/update/'.$id.'');
        ...
        //product data 
        $data['usuario'] = $this->usuariodao->get_usuario_by_id($id);
        //load the view
        $data['main_content'] = 'admin/usuario/edit';
        $this->load->view('includes/template', $data);            
    ...
    */
    public function delete()
    {
        ...
        $id = $this->uri->segment(4);
        $this->usuariodao->delete_usuario($id);
