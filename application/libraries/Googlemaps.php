...
class Googlemaps {
	...
	var $center						= "-15.78, -53";		// Sets the default center location (lat/long co-ordinate or address) of the map. If defaulting to the users location set to "auto"
	...
	function create_map()
	{
		...
		if ($this->maps_loaded == 0)
		{
			...
			<script type="text/javascript" src="' .  base_url().'assets/portal/js/markerclusterer.js"></script>
			'; }
		}
		if ($this->jsfile=="") {
			$this->output_js .= '
